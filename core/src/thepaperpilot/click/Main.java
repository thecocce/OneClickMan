...
import thepaperpilot.click.screens.TitleScreen;
...
public class Main extends Game implements Screen {
	...
	public void create() {
		...
		instance = this;
		Player.setPreferences(Gdx.app.getPreferences("thepaperpilot.click.save"));
	...
	public void render(float delta) {
		...
		if (manager.update()) {
			if (skin == null) {
				...
				skin.getFont("large").getRegion().getTexture().setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
